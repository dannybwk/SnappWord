...
export const languageDistribution = [
  { name: "英語", value: 18, fill: "#74B9FF" },
  { name: "日語", value: 12, fill: "#FFB7C5" },
  { name: "西班牙語", value: 9, fill: "#06C755" },
  { name: "韓語", value: 5, fill: "#FFE66D" },
  { name: "法語", value: 3, fill: "#A8E6CF" },
] as const;

export const recentVocab = [
  {
    id: "1",
    word: "serendipity",
    translation: "意外的驚喜發現",
